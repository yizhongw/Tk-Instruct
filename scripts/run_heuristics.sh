...
python src/compute_metrics.py --predictions ${output_dir}/default/copy_demo/predicted_examples.json --track default
...
python src/compute_metrics.py --predictions ${output_dir}/default/copy_input/predicted_examples.json --track default
...
python src/compute_metrics.py --predictions ${output_dir}/xlingual/copy_demo/predicted_examples.json --track xlingual
...
python src/compute_metrics.py --predictions ${output_dir}/xlingual/copy_input/predicted_examples.json --track xlingual