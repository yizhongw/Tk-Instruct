...
python src/run_baselines.py --task_dir data/tasks --data_dir data/splits/xlingual --max_num_instances_per_task 1 --max_num_instances_per_eval_task 100 --method copy_demo
echo "Copy_input for x-lingual track"
python src/run_baselines.py --task_dir data/tasks --data_dir data/splits/xlingual --max_num_instances_per_task 0 --max_num_instances_per_eval_task 100 --method copy_input